...
!function ($) {
    ...
    $.fn.valid = function (object, options, isshowMsg) {
    ...
    var validateField = function (field, valid) {
            ...
            if (rules && rules.length > 0)
                for (j = 0; j < rules.length; j++) {
                    ...
                    if (flag == rule.name) {
                        ...
                        var result = rule.validate.call(field, value);
                        if (result == null)
                            error = null;
                        else if (result == x) {
                            error = true;
        ...
        if (form) {
            ...
            if (fstyle == 0) {
                ...
                var parent = el.parents("[class^=col-]");
                if (parent && parent.length > 0)
                    $(parent[0]).after('<span class="help-block" id="valierr">' + errorMsg + '</span>');
                else
