...
namespace Tz.Domain.Services
{
    public class RoleModulesService
    {
        ...
        public RoleModulesService(IRepositoryContext repositoryContext, IRolePermissionRepository rolePermissionRepository, IModuleRepository moduleRepository)
        {
        ...
        public RoleModulesService(IRepositoryContext repositoryContext, IRolePermissionRepository rolePermissionRepository)
        {
            this._repositoryContext = repositoryContext;
            this._rolePermissionRepository = rolePermissionRepository;
        }
